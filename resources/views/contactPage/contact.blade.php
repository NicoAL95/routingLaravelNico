...
<body class="bg-[#FBE5FF] overflow-x-hidden">
  <header>
    <nav>
      <div>
      ...
      <ul class="navLinks right-[-50%] bg-[#FBE5FF] xl:bg-transparent" id="navLinks">
      ...
      <div class="bodySplit">
        <div class="bodyCol flex items-center pl-[80px]">
          <div>
            ...
            <div class="headTitle">
              <h1>Halo Semua<br>Ini Adalah Tampilan<br>Contact Page</h1>
            </div>
        ...
        <div class="bodyCol">
          <img src="/img/svg/illustrator-head-4.svg" alt="">
        </div>
      </div>
    </section>
  </main>
